...
var MainChatComponent = /** @class */ (function () {
    ...
    MainChatComponent.prototype.getMessagesForSelectedChannel = function () {
        ...
        var orderedQuery = firestore_1.query(groupChatRef, firestore_1.orderBy('send', 'asc'));
        this.unsubscribeMessages = firestore_1.onSnapshot(orderedQuery, function (querySnapshot) {
            ...
            _this.sortMessagesByTime();
        });
    };
    MainChatComponent.prototype.sortMessagesByTime = function () {
        this.messages.sort(function (a, b) {
            var timeA = a.sentDate + ' ' + a.sentTime;
            var timeB = b.sentDate + ' ' + b.sentTime;
    ...
    MainChatComponent.prototype.triggerFileUpload = function () {
        this.fileInput.nativeElement.click();
    };
    MainChatComponent.prototype.handleFileInput = function (files) {
        var _this = this;
    ...
    MainChatComponent.prototype.sendMediaMessage = function (file, downloadURL) {
        var _this = this;
        var channelUserIds = this.selectedChannel.channelUser.map(function (user) { return user; });
        var currentDate = new Date();
        var formattedDate = this.formatDate(currentDate);
        ...
        this.sendMessageToGroupChat(this.channelService.selectedChannel.id, message).then(function () {
            _this.messageText = '';
        });
    };
    ...
    ], MainChatComponent.prototype, "fileInput");
    __decorate([
